                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    st.continueWithTask(new Continuation() {
                                        ...
                                        public void onComplete(@NonNull Task task) {
                                            ...
                                            muser.put("email",smail);
                                            muser.put("type",type);
                                            muser.put("username",susername);
                                            muser.put("imagepath",imguri+"");
                                            muser.put("field",sfield);


                                            dref.set(muser).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void aVoid) {
