...
public class proposalDoc extends AppCompatActivity implements View.OnClickListener, Callback {
    ...
    ImageView done,plusmember,plusneeds,plusoutputs,plusfeatures,plusAPI,plusAlg,plusindi,plusSoc, plusOrg, plusRef;
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                fs.collection("proposalDoc").add(pd).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                    ...
                                    public void onSuccess(DocumentReference documentReference) {
                                        ...
                                        Document d = new Document(userID,"proposal",name.getText().toString(),documentReference.getId(),pid,ver);
    ...
    public void SaveProposolDoc (){
        ...
        for (int i = 0; i < needsList.getChildCount(); i++) {
            ...
            EditText needs = (EditText) v1.findViewById(R.id.need);
...
//        final android.app.AlertDialog.Builder builder = new AlertDialog.Builder(proposalDoc.this);
//        builder.setTitle("Save");
//        builder.setMessage("Do you want to save the Document?");
