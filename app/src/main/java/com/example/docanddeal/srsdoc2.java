...
public class srsdoc2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_srsdoc2);
        ...
        if(abbr!=null) {
            da = new AbbrevAdapter(abbr, srsdoc2.this,pro2);
            rv.setAdapter(da);
        }
        ...
        plusExplination.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(srsdoc2.this)
                        .setTitle("Save")
                        .setMessage("Do you want to save the Document?")
                        .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i = new Intent(srsdoc2.this, ProjectDetails.class);
                                ...
                                fs.collection("documents").whereEqualTo("pid",pid).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                                    ...
                                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                        ...
                                        for (DocumentSnapshot ds: queryDocumentSnapshots) {
                                            ...
                                            if(d.getName().equals(pdn.getDname()) && d.getVerid().equals(p.getVersion()))
                                                Toast.makeText(srsdoc2.this,"Document name already exists",Toast.LENGTH_LONG).show();
                                            else{
