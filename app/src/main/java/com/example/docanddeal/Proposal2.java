                                    ...
                                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                        ...
                                        for (DocumentSnapshot ds: queryDocumentSnapshots) {
                                            ...
                                            if(d.getName().equals(pdn.getDname()) && d.getVerid().equals(p.getVersion()))
                                                Toast.makeText(Proposal2.this,"Document name already exists",Toast.LENGTH_LONG).show();
                                            else{
                                                fs.collection("proposalDoc").add(pdn).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                    ...
                                                    public void onSuccess(DocumentReference documentReference) {
                                                        ...
                                                        Document d = new Document(userID,"proposal",pdn.getDname(),documentReference.getId(),pid,ver,null);
