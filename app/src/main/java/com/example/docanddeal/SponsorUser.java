...
public class SponsorUser extends User implements Serializable {
    ...
    public SponsorUser(String email, String imagepath, String type, String username, String id, ArrayList<String> sharedProjects,
